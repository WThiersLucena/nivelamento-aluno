...
######################################################################################################################################
puts
puts " Seja Bem Vindo ao Sistema para indicar a cor da fase pandêmica em SP : "
puts 
...
# testes
# testes  puts " Testando o sistema com outros valores "
# testes puts
# testes puts fase_pandemica(0.81 , 0.1 , 0.2) #FASE AZUL
# testes puts fase_pandemica(0.2 , 0.8 , 0.4) #FASE VERDE
# testes puts fase_pandemica(0.1 , 0.8 , 0.6) #FASE AMARELA
# testes puts fase_pandemica(0.1 , 0.2 , 0.67) #FASE LARANJA
